...
{
    /// <summary>
    /// Convert a <see cref="Result"/> to a <see cref="MatchObjectResult"/>
    ...
    /// <returns>The <see cref="MatchObjectResult"/> for the response.</returns>
    public static MatchObjectResult ToActionResult(this Result result,
        string? createdPath = null)
        => new(result, createdPath);

    /// <summary>
    /// Convert a <see cref="Result{TValue}"/> to an <see cref="MatchObjectResult{TValue}"/>
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <param name="result">The <see cref="Result{TValue}"/> to be converted.</param>
    /// <returns>The <see cref="MatchObjectResult{TValue}"/> for the response.</returns>
    public static MatchObjectResult<TValue> ToActionResult<TValue>(this Result<TValue> result)
        => new(result);
